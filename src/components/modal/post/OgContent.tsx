          ...
          <div className="relative px-2 mb-3 select-none">
            <div
              className={`${
                loading
                  ...
                  : "hover:bg-red-400 dark:hover:bg-white cursor-pointer hover:border-none dark:hover:border-solid"
              } ${
                postStyle === "desktop"
              ...
              } border border-neutral-400 absolute h-5 w-5 -top-2 rounded-full p-2 flex justify-center items-center pointer-events-auto transition-colors ease-out`}
              onClick={() => !loading && setOgStack(removeLastIndex(ogStack))}
            >
            ...
            >
              {post.og.image?.url && (
                <img
                  className={`${
                    loading && "grayscale-[50%]"
                  } mr-2.5 shadow h-9 aspect-video object-cover rounded-sm`}
