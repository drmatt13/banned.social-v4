  ...
  return (
    <>
      <div
        ...
        className="cursor-text pointer-events-auto z-50 h-10 w-72 max-w-[67.5vw] bg-black/10 dark:bg-white/10 hover:bg-white/25 focus-within:bg-white/25 dark:hover:bg-white/[15%] dark:focus-within:bg-white/[15%] backdrop-blur flex items-center px-4 text-sm rounded-full text-gray-500 dark:text-gray-300 border border-white/25 hover:border-black/25 focus-within:border-black/25 dark:border-black/25 dark:hover:border-white/10 dark:focus-within:border-white/10 transition-colors duration-300 ease-out group"
      >
